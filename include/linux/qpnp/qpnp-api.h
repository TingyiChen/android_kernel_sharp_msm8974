...
struct qpnp_bms_calc_base_info
{
	...
	int				pre_bat_therm;
	int				pon_bat_therm;
	unsigned int	pre_rtc_data;
	unsigned int	pon_rtc_data;
...
{ return -ENXIO; }
static inline int qpnp_bms_store_battery_info(int capacity, int bat_therm)
{ return -ENXIO; }
static inline int qpnp_bms_read_battery_capacity(struct qpnp_bms_calc_base_info *info)
{ return -ENXIO; }
...
{ return -ENXIO; }
static inline int qpnp_chg_charger_ibatmax_get(int *chg_current)
{ return -ENXIO;}
...
static inline int qpnp_flash_control_enable(bool enable)
{ return -ENXIO; }
static inline int qpnp_chg_flash_is_enable(void)
{ return 0; }

/* not qpnp-charger function */
static inline int qpnp_bbclk2_control_enable(bool enable)
{ return -ENXIO; }
