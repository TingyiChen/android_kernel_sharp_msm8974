...
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE30         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     ...
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE31         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_COMMAND_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE32         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_BOOT_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE33         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_MIF_STR        \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE34         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_HSERROR_STR       \
                                                     SHDISP_DBG_SUBCODE_NOTCOMP_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE35         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_HSERROR_STR       \
                                                     SHDISP_DBG_SUBCODE_MISMATCH_STR   \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE36         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_CMDERR_STR        \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE37         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_ASYNCERR_STR      \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE38         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_HW_STR       \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE39         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_CLMR_HW_STR       \
                                                     SHDISP_DBG_CODE_UNKHINT_STR       \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE40         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE41         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_STATUS_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE42         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_DISPNG_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE43         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_BDIC_STR          \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_I2CREAD_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE44         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSALSNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE45         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_POWERNG_STR    \
                                                     "   0  \n")
...
const static struct shdisp_dbg_error_code ErrorCodeIndex[] = {
    ...
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_COMMAND          },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_BOOT             },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_MIF              },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NOT_COMPLETE     },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NUMBER_MISMATCH  },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_COMMAND_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_ASYNC_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_DEVCODE          },
    {SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_UNKNOWN_HINT,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
...
static size_t shdisp_dbg_get_stacktrace(char *stackdumpbuf, size_t length)
{
   ...
   SHDISP_INFO("shdisp_dbg_get_stacktrace ptr=0x%p len=%d\n", stackdumpbuf, length);
    while (1) {
        int urc, rtn;
    ...
    SHDISP_INFO("dump stuck trace size=%d\n", writelen);
    return writelen;
}
...
static void shdisp_dbg_summary_countup_line(char *buf)
{
    ...
    if (*pCount1000 == '9' && *pCount100 == '9' && *pCount10 == '9' && *pCount1 == '9') {
        SHDISP_INFO("Counter is Max Value %c%c%c%c\n", *pCount1000, *pCount100, *pCount10, *pCount1);
        return;
    }
...
static void shdisp_dbg_reset_work_add_command(struct shdisp_dbg_reset_work_command *cmd)
{
    SHDISP_INFO("add queue: proc=%pS arg=%p\n", cmd->proc, cmd->arg);
...
static void shdisp_dbg_reset_work_worker(struct work_struct *wk)
{
    ...
    for (; ;) {
        ...
        SHDISP_INFO("execute: proc=%pS arg=%p\n", cmd->proc, cmd->arg);
