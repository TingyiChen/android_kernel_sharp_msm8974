 ...
 */
	...
	#define SHTPS_PERFLOCK_TU_RELEASE_DISABLE
	#define SHTPS_PERFLOCK_DOZE_DISABLE
...
#define SHTPS_LOW_REPORTRATE_MODE
 ...
 */
	...
	#define SHTPS_PERF_LOCK_CLOCK_FREQUENCY				PERF_LOCK_1728000KHz
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD_DEF, 	0x1D);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_1_PEN_CHATT_Z_THRESHOLD_MAX,			28);
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_1_PEN_CHATT_TAP_CNT,					4);
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_2_FINGER_Z_THRESHOLD, 					30);
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_3_1_Z_THRESHOLD, 						1);
	...
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_4_PEN_Z_FLUCTUATE,	 					5);
	...
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_6_PEN_CHATT_Z_THRESHOLD_COND,			11);
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_6_PEN_CHATT_Z_THRESHOLD_COND_2,			2);
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_6_PEN_CHATT_Z_THRESHOLD_MIN,			8);
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_6_PEN_CHATT_Z_THRESHOLD_MAX,			31);
	...
	SHTPS_PARAM_DEF( SHTPS_HOVER_REJECT_READ_TOUCH_EVENT_POLLING_TIME_MS, 		32);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_DRAG_MAX_NUM,		4);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_DRAG_YDIFF_COND,	8);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_MV,	500);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_MV_ST,	15);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_TD,	0);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_TD_ST,	0);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_MV, 		15);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_MV_ST, 	20);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_TD, 		0);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_TD_ST,		0);

	#if defined(SHTPS_PEN_DETECT_ENABLE)
		SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_PEN_ONLY,		1);
	#endif /* SHTPS_PEN_DETECT_ENABLE */
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_CTRL_FW_REPORT_RATE_REG_ADDR, 			0x040A);
	SHTPS_PARAM_DEF( SHTPS_CTRL_FW_REPORT_RATE_PARAM, 				0x50);
#endif /* SHTPS_CTRL_FW_REPORT_RATE */

/* -----------------------------------------------------------------------------------
 */
#if defined( SHTPS_LOW_REPORTRATE_MODE )
	SHTPS_PARAM_DEF( SHTPS_LOW_REPORTRATE_MODE_ENABLE, 				1);
	SHTPS_PARAM_DEF( SHTPS_REPORT_RATE_PARAM_DEFAULT, 				0x50);
	SHTPS_PARAM_DEF( SHTPS_REPORT_RATE_PARAM_LOW,					0x3C);
	SHTPS_PARAM_DEF( SHTPS_REPORT_RATE_REG_ADDR,		 			0x040A);
	
	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		SHTPS_PARAM_DEF( SHTPS_LOW_REPORTRATE_MODE_LOG_ENABLE, 	0);
	    #define	SHTPS_LOG_DBG_LOW_REPRATE_PRINT(...)				\
	        if(SHTPS_LOW_REPORTRATE_MODE_LOG_ENABLE != 0){	\
	            printk(KERN_DEBUG "[shtps] [low_reportrate]" __VA_ARGS__);	\
	        }
	#else
		#define	SHTPS_LOG_DBG_LOW_REPRATE_PRINT(...)
	#endif /* SHTPS_LOG_DEBUG_ENABLE */
