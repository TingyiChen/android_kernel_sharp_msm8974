...
#if defined(CONFIG_SHSYS_CUST)
#if defined(CONFIG_SHIRDA) || defined(CONFIG_SERIAL_MSM_HSL_CONSOLE)
static struct msm_serial_hslite_platform_data blsp2_uart2_data = {
	.config_gpio = 1,
	.uart_tx_gpio = 45,
	.uart_rx_gpio = 46,
//	.uart_cts_gpio,
...
#if defined(CONFIG_SHSYS_CUST)
#if defined(CONFIG_SHIRDA) || defined(CONFIG_SERIAL_MSM_HSL_CONSOLE)
	OF_DEV_AUXDATA("qcom,msm-lsuart-v14", 0xF995E000, \
			"f995e000.serial", &blsp2_uart2_data),
#endif /* defined(CONFIG_SHIRDA) || defined(CONFIG_SERIAL_MSM_HSL_CONSOLE) */
#endif /* defined(CONFIG_SHSYS_CUST) */
